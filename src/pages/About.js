  ...
  return (
    <div >
        ...
        <div className="container2">
          <h1>about us</h1>
          <h3 className="schrift">hello everyone, <br />we are Nico and Leon <br />two ambitious brothers <br />who want to make the world a better place<br />sounds kind of pathetic but with a peaceful mind<br />hearts full of love<br />it is possible to transmit the right values<br /> we need<br /> to live in a harmlessly open world<br />where anybody can be themselves<br />and nobody gets threatend by other human<br />it's a long way to go<br />let's start right here </h3>
        </div>
